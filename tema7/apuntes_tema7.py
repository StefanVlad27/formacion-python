...
# clases: una clase es una plantilla o un modelo que define la estructura y el comportamiento de los objetos que se crearán a partir de ella

class Pajaro:
    pass

mi_pajaro = Pajaro() # así se define un objeto. en este caso se ha definido el objeto mi_pajaro a raiz de la clase
...
class Pajaro:
    ...
    def __init__(self, color): # así se define el metodo constructor que va a asignar un atributo a la clase
        self.color = color
...
# Uso de la función:
eliminar_acentos_en_archivo('C:\\Users\\stefanvlad\\source\\repos\\formacion-python\\tema7\\apuntes_tema7.py', 'C:\\Users\\stefanvlad\\source\\repos\\formacion-python\\tema6\\apuntes_tema_7_sin_tildes.py')
